...
python scripts/run_baselines.py --features results/features/clip_vit_b16_rad.npz
...
python scripts/extract_timm_features.py --config configs/resnet18.yaml --output results/features/resnet18_rad.npz
python scripts/run_visual_multiview.py --features results/features/resnet18_rad.npz --prefix resnet18_visual

python scripts/run_strong_baselines.py --device auto
